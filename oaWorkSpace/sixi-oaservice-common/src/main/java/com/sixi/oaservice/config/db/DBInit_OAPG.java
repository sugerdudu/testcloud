 ...
 */
@Configuration
public class DBInit_OAPG {
	private final String MapperPath="classpath*:com/sixi/oaservice/**/mapper/oapg/**/*.xml";
	private final String DataSourceBean="dataSource_oapg";
	private final String SQLSessionFactoryBean="sqlSessionFactory_oapg";
	private final String PackageName="com.sixi.oaservice.**.mapper.oapg";
	private final String txStr = "oaPg";
	/**
	 * 不要乱写，可选值为oracle,mysql,mariadb,sqlite,hsqldb,postgresql,db2,sqlserver,informix,h2,sqlserver2012
	 */
	private final String pageHelper = "postgresql";
	...
	public DataSource dataSource(DBConfigInfo dbinfo){
		...
		return DBConfigUtils.getDruid(dbinfo.getOapg());
	}
