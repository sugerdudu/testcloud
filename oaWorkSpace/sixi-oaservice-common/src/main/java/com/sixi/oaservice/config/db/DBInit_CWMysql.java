 ...
 */
@Configuration
public class DBInit_CWMysql {
    private final String MapperPath = "classpath*:com/sixi/oaservice/mapper/cwmysql/**/*.xml";
    private final String DataSourceBean = "dataSource_cwmysql";
    private final String SQLSessionFactoryBean = "sqlSessionFactory_cwmysql";
    private final String PackageName = "com.sixi.oaservice.mapper.cwmysql";
    private final String txStr = "cwmysql";
    ...
    public DataSource dataSource(DBConfigInfo dbinfo) {
        ...
        return DBConfigUtils.getDruid(dbinfo.getCwmysql());
    }
