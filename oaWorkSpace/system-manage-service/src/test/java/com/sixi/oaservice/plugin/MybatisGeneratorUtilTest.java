...
public class MybatisGeneratorUtilTest {
    ...
    public void test() throws Exception {
        ...
        MybatisGeneratorUtil.generator(dbInfo.getDriver(),dbInfo.getUrl(),dbInfo.getUsername(),dbInfo.getPassword(),"data_dic","system-manage-service","com.sixi.oaservice.systemmanageservice","oapg","ogPg","system","datadic");
    }
